    ...
    <?php elseif ( is_single() ) : ?>
		...
		<?php elseif ( 'portfolio' == get_post_type() ) : ?>
			...
			<h6><?php printf( __( 'Home / Portfolio / %1$s', 'rokophoto' ), get_the_title() ); ?></h6>
	...
	<?php elseif ( is_author() ) : ?>
		...
		<h6><?php printf( __( 'Posts By: %1$s', 'rokophoto' ), get_the_author_meta( 'display_name', $user_id ) ); ?></h6>

	<?php elseif ( is_day() || is_month() || is_year() ) : ?>

		<?php
		if ( is_day() )
			$date = get_the_time( __( 'F d, Y', 'rokophoto' ) );
		elseif ( is_month() )
			$date = get_the_time( __( 'F Y', 'rokophoto' ) );
		elseif ( is_year() )
			$date = get_the_time( __( 'Y', 'rokophoto' ) );
		?>
    ...
    <?php elseif ( is_archive() ) : ?>
		...
		<h6><?php _e( 'Archives', 'rokophoto' ); ?></h6>
        
    <?php elseif ( is_404() ) : ?>

		<h6><?php _e( 'Ouch!', 'rokophoto' ); ?></h6>
